...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.clickBFFTest = function () {
        var _this = this;
        this.response = {};
        this.httpClient.get('api/test').subscribe(function (success) {
            console.log('success');
            _this.response = success;
        }, function (failure) {
            console.log('failure');
            _this.response = failure;
        }, function () {
            console.log('completed');
        });
    };
    AppComponent.prototype.clickGoTest = function () {
        var _this = this;
        this.response = {};
        this.httpClient.get('go/test?name=GO').subscribe(function (success) {
            console.log('success');
            _this.response = success;
        }, function (failure) {
            console.log('failure');
    ...
    AppComponent.prototype.clickGoError = function () {
        var _this = this;
        this.response = {};
        this.httpClient.get('go/error').subscribe(function (success) {
            console.log('success');
            _this.response = success;
        }, function (failure) {
            console.log('failure');
...
module.exports = __webpack_require__(/*! /Users/josephgill/joegill/ui.josephgill.io/client/src/main.ts */"./src/main.ts");


/***/ })

},[[0,"runtime","vendor"]]]);
//# sourceMappingURL=main.d1a89a31fd0946a3124f.js.map