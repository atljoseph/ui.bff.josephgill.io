...
//     constructor() {
//         this._baseConfig = {
//             algorithm: (process.env.BFF_JWT_ALGO as JWTAlgorithm) || 'HS256',
//             issuer: process.env.BFF_JWT_ISS || 'JoeGill',
//             expiresIn: process.env.BFF_JWT_EXP || (7 * 24 * 60 * 60),
//         }
//         this._jwtSecret = process.env.BFF_JWT_SECRET || 'myjwtsecret';
//     }
